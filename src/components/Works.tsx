          ...
          <div className={`${WorksStyle.project} ${WorksStyle.right}`}>
            ...
            <div className={WorksStyle.projectDescription}>
              ...
              <p className={WorksStyle.projectText}>
                I started working in Domomi Rentals from the BCIT co-opertive
                ...
                Kijiji and Craigslist and update them to a database. I also
                created a recommendation system for users of app based on what
                they found important to be near such as a grocery store or
                school.
              </p>
            ...
            >
              ...
              <div className={WorksStyle.projectDescription}>
                ...
                <p className={WorksStyle.projectText}>
                  ...
                  in need for certain tools Spotify didn't provide, so I created
            ...
            <div className={`${WorksStyle.project}`}>
              ...
              <div className={WorksStyle.projectDescription}>
                ...
                <p className={WorksStyle.projectText}>
                  ...
                  Comment, reply or like other peoples comment. I worked on the
                  Back-End which was written in JavaScript using Express.js.
                  There I handled when users, liked, commented or replied as
                  well as create their accounts. This was all stored in a
                  PostgreSQL database.
                </p>
                <ul className={WorksStyle.technologies}>
                  <li>React</li>
          ...
          <div className={`${WorksStyle.workSection} ${WorksStyle.left}`}>
            ...
            >
              ...
              <div className={WorksStyle.projectDescription}>
                <h2>Keebie.io</h2>
                <p className={WorksStyle.projectText}>
                  One of my hobbies is building keyboard so I wanted to create a
                  project that had something to do with that. I created
                  Keebie.io to list popular keyboard switches and display their
                  details such as whether they are clickly, tactile or linear
